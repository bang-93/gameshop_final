					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="#deleteEmployeeModal" onClick="deleteBoard(<%=board.getBoard_id() %>);" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
							</td>
						</tr>
							<%} %> 
					</tbody>
			...
			<div class="modal-content">
				<form>
					...
					<div class="modal-footer">
						...
						<input type="hidden" id="delBoard_id">
					</div>
				</form>
			</div>
		</div>
