...
<script type="text/javascript">
    ...
    /** 게시판 - 상세 페이지 이동 */
    function goReBoardDetail(boardSeq){                
        location.href = "/client/reboardDetail?boardSeq="+ boardSeq;
    }
    
    /** 게시판 - 작성 페이지 이동 */
    function goReBoardWrite(){        
        location.href = "/client/reboardWrite";
    }
 
    /** 게시판 - 목록 조회  */
    function getReBoardList(currentPageNo){
    ...
    /** 게시판 - 목록 조회  콜백 함수 */
    function getReBoardListCallback(obj){
        ...
        if(state == "SUCCESS"){
            ...
            if(listLen >  0){
                ...
                for(var a=0; a<listLen; a++){
                    ...
                    str += "<td onclick='javascript:goReBoardDetail("+ boardSeq +");' style='cursor:Pointer'>";
            ...
            $("#pagination_reboard").html(pagination);
...
<div id="wrap">
    <div id="container">
        <div class="inner">        
            <span class="reboard_head">고객센터</span>            
            <form id="reboardForm" name="reboardForm">
                <input type="hidden" id="function_name" name="function_name" value="getReBoardList" />
            ...
            <div class="btn_right mt15">
                <button type="button" class="btn black mr5" onclick="javascript:goReBoardWrite();">작성하기</button>
            </div>
        </div>
        
        <div id="pagination_reboard"></div>
