...
<script type="text/javascript">
    ...
    /** 게시판 - 작성 콜백 함수 */
    function insertReBoardCallback(obj){
...
<div id="wrap">
    <div id="container">
        <div class="inner">        
            <span class="reboard_head">게시글 작성</span>
            ...
            <div class="btn_right mt15">
                ...
                <button type="button" class="btn black" onclick="javascript:insertReBoard();">등록하기</button>
            </div>
        </div>
    </div>
</div>
