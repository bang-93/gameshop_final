...
<script type="text/javascript">
        ...
        if(yn){
            ...
            $.ajax({    
                ...
                success : function(obj) {
                    insertReBoardReplyCallback(obj);                
                },           
    ...
    /** 게시판 - 작성 콜백 함수 */
    function insertReBoardReplyCallback(obj){
...
<div id="wrap">
    <div id="container">
        <div class="inner">        
            <span class="reboard_head">답글 작성</span>
            ...
            <div class="btn_right mt15">
                ...
                <button type="button" class="btn black" onclick="javascript:insertReBoardReply();">등록하기</button>
            </div>
        </div>
    </div>
</div>
