...
<script type="text/javascript">
    ...
    /** 게시판 - 수정 콜백 함수 */
    function updateReBoardCallback(obj){
...
<div id="wrap">
    <div id="container">
        <div class="inner">    
            <span class="reboard_head">게시글 수정</span>
            ...
            <div class="btn_right mt15">
                ...
                <button type="button" class="btn black" onclick="javascript:updateReBoard();">수정하기</button>
            </div>
        </div>
    </div>
</div>
